...
function twentyfourteen_custom_header_setup() {
	 ...
	 *     @type int    $height                 Height in pixels of the custom header image. Default 310.
...
?>
            <div class="site-logo">
        <h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri(); ?>/images/logo_malaco-trans.png" /></a></h1>
    </div>	
	<div id="headimg">
